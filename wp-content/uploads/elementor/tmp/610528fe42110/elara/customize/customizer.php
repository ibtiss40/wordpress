...
function elara_customizer_panels_sections( $wp_customize ) {
    ...
    if ( function_exists( 'wpforms' ) ) {
        // elara_section_wpforms
        $wp_customize->add_section( 'elara_section_wpforms', array(
            'title'       => esc_html__( 'WPForms', 'elara' ),
            'priority'    => 96,
        ) );
    }
...
function elara_customizer_fields( $fields ) {
	...
	$fields[] = array(
		'type'        => 'toggle',
		'settings'    => 'elara_wpforms_override',
		'label'       => esc_html__( 'Override WPForm Styling?', 'elara' ),
		'description' => esc_html__( 'Whether to modify WPForm styling to match the look and feel of your theme, Elara.', 'elara' ),
		'section'     => 'elara_section_wpforms',
		'priority'    => 2,
		'default'     => $elara_defaults['elara_wpforms_override']
	);
