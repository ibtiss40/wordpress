 ...
 */
require get_template_directory() . '/inc/back-compatibility.php';
...
function elara_setup() {
	...
	load_theme_textdomain( 'elara', get_template_directory() . '/lang' );
...
function elara_scripts() {
    ...
    if ( function_exists( 'wpforms' ) && elara_get_option( 'elara_wpforms_override') ) {
