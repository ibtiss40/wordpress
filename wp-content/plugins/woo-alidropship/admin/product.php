...
class VI_WOO_ALIDROPSHIP_Admin_Product {
	...
	public function woocommerce_process_product_meta_simple( $product_id ) {
		$skuAttr = isset( $_POST['vi_wad_simple_variation_attr'] ) ? sanitize_text_field( $_POST['vi_wad_simple_variation_attr'] ) : '';
		if ( $skuAttr ) {
			update_post_meta( $product_id, '_vi_wad_aliexpress_variation_attr', $skuAttr );
		}
		$skuID = isset( $_POST['vi_wad_simple_variation_id'] ) ? sanitize_text_field( $_POST['vi_wad_simple_variation_id'] ) : '';
		if ( $skuID ) {
	...
	public function woocommerce_save_product_variation( $variation_id, $i ) {
		$skuAttr = isset( $_POST['vi_wad_variation_attr'], $_POST['vi_wad_variation_attr'][ $i ] ) ? sanitize_text_field( $_POST['vi_wad_variation_attr'][ $i ] ) : '';
		if ( $skuAttr ) {
			update_post_meta( $variation_id, '_vi_wad_aliexpress_variation_attr', $skuAttr );
		}
		$skuID = isset( $_POST['vi_wad_variation_id'], $_POST['vi_wad_variation_id'][ $i ] ) ? sanitize_text_field( $_POST['vi_wad_variation_id'][ $i ] ) : '';
		if ( $skuID ) {
